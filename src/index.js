...
import { photoShow } from './app/photoShow';
import { queryResult } from './app/queryResult';
...
function searchPhotos(find) {
  ...
  async function render() {
    try {
      const { data: response } = await photoShow(querySearch, page, perPage);
      if (querySearch === '') {
